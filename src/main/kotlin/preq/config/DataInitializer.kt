...
class DataInitializer(
    ...
    private fun createPriceReports(products: List<Product>, locations: List<Location>) {
        products.forEach { product ->
            ...
            locations.shuffled(rng).take(locationCount).forEach { location ->
                ...
                generateDates(reportCount).forEach { date ->
                    ...
                    locationProductPriceRepository.save(LocationProductPrice().apply {
    ...
    private fun findReference(product: Product): ProductReference? {
        return productReferences.firstOrNull {
